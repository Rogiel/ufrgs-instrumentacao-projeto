...
\section{Pluviômetro}
\todo{tirar referência da wikipedia}
...
No sistema montado foram utilizados os seguintes componentes indicados nas Equações abaixo
...
A sensibilidade do sistema digital é de 
...
/**
 * A structure containing the measurement ID and cicle count
 */
struct measurement_t {
    ...
    /**
     * The number of cicles that happened between the last two 
...
\bibitem{capacitor-plano} K. J. Binns and P. J. Lawrenson (Auth.), Analysis and Computation of Electric and Magnetic Field Problems - 2ª Ed., Pergamon Press, 1973.
